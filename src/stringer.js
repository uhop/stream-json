...
stringer.asStream = options => asStream(stringer(options), Object.assign({}, options, {writableObjectMode: true, readableObjectMode: false}));
stringer.make = stringer.asStream;
