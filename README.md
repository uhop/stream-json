...
- 1.7.4 _updated dependency (`stream-chain`), bugfix: inconsistent object/array braces. Thx [Xiao Li](https://github.com/xli1000)._
- 1.7.3 _added an assembler option to treat numbers as strings._
- 1.7.2 _added an error check for JSONL parsing. Thx [Marc-Andre Boily](https://github.com/maboily)._
- 1.7.1 _minor bugfix and improved error reporting._
- 1.7.0 _added `utils/Utf8Stream` to sanitize `utf8` input, all parsers support it automatically. Thx [john30](https://github.com/john30) for the suggestion._
- 1.6.1 _the technical release, no need to upgrade._
- 1.6.0 _added `jsonl/Parser` and `jsonl/Stringer`._
