...
const assembleText = (text, options) =>
...
test.asPromise('flexAssembler: maxDepth throws on over-deep input', async (t, resolve, reject) => {
  try {
...
test.asPromise('flexAssembler: maxDepth passes at the limit and throws past it', async (t, resolve, reject) => {
  try {
...
test.asPromise('flexAssembler: maxDepth defaults to a finite limit', async (t, resolve, reject) => {
  try {
...
test.asPromise('flexAssembler: maxDepth Infinity disables the limit', async (t, resolve, reject) => {
  try {
...
test.asPromise('flexAssembler: maxDepth applies only when rules are configured', async (t, resolve, reject) => {
  try {
